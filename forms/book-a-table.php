<?php
  ...
  $receiving_email_address = 'delizioso.caffe@gmail.com';
  ...
  $book_a_table->add_message( $_POST['date'], 'Seleccionar Fecha', 4);
  $book_a_table->add_message( $_POST['time'], 'Hora', 4);
  $book_a_table->add_message( $_POST['people'], '# Personas', 1);
